...
public:
    void DrawDot(const glm::vec3 &position, const f32 radius = 1) override;
    ...
    void DrawTexture(const std::array<glm::vec3, 4> &positions, const sptr<resources::Texture> &tex) override;
